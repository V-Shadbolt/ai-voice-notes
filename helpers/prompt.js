export function adjustTranscript(transcript, date) {
    return `
...
export function getPrompt() {
    ...
    prompt.summary = `Key "summary" - create a summary that is roughly 10-15% of the length of the transcript.`;
    ...
    prompt.stories = `Key "stories:" - add an array of an stories or examples found in the transcript. Limit each item to 200 words, and limit the list to 3 items.`;
    ...
    prompt.example = `Here is example formatting, which contains example keys for all the requested summary elements and lists. Be sure to include all the keys and values that you are instructed to include above. Example formatting: ${exampleObject}`;
